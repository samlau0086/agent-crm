...
export const PATCH = withApiMetrics("PATCH /api/saved-views/[id]", patchApiMetricsHandler);
...
export const DELETE = withApiMetrics("DELETE /api/saved-views/[id]", deleteApiMetricsHandler);
