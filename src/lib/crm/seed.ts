...
const salesDocumentFields = salesDocumentObjects.flatMap((object) => [
  ...
  { id: `field-${object.key}-payment-term`, workspaceId: defaultWorkspaceId, objectKey: object.key, key: "paymentTerm", label: "付款条款", type: "select" as const, required: true, unique: false, options: paymentTermOptions, defaultValue: "net_30", isSystem: true, position: 6 },
...
export const seedData: CrmSnapshot = {
  ...
  fieldDefinitions: [
    ...
    { id: "field-contact-temp-customer-level", workspaceId: defaultWorkspaceId, objectKey: "contacts", key: "contactTempCustomerLevel", label: "\u4e34\u65f6\u5ba2\u6237\u7b49\u7ea7", type: "select", required: false, unique: false, options: [{ label: "A \u7ea7\u5ba2\u6237", value: "A" }, { label: "B \u7ea7\u5ba2\u6237", value: "B" }, { label: "C \u7ea7\u5ba2\u6237", value: "C" }, { label: "D \u7ea7\u5ba2\u6237", value: "D" }], isSystem: true, position: 11 },
    { id: "field-company-domain", workspaceId: defaultWorkspaceId, objectKey: "companies", key: "domain", label: "域名", type: "text", required: false, unique: true, isSystem: true, position: 1 },
