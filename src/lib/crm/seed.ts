...
export const seedData: CrmSnapshot = {
  ...
  fieldDefinitions: [
    ...
    { id: "field-contact-avatar", workspaceId: defaultWorkspaceId, objectKey: "contacts", key: "avatarUrl", label: "头像 URL", type: "text", required: false, unique: false, isSystem: true, position: 7 },
    ...
    { id: "field-company-logo", workspaceId: defaultWorkspaceId, objectKey: "companies", key: "logoUrl", label: "Logo URL", type: "text", required: false, unique: false, isSystem: true, position: 5 },
